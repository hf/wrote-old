...
public class Wrote.TextBuffer: Gtk.TextBuffer {
  // maximum number of characters to attempt word count immediately
  // arround 10000 words of Lorem Ipsum as generated by lipsum.com
  public const int WORD_COUNT_CHARS = 67645;
